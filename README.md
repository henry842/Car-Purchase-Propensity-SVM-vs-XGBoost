# Car Purchase Propensity - SVM vs XGBoost
...
Model comparison, propensity scoring and classification. This project was organized as a portfolio-ready case study: it explains the objective, the analytical path, the visual evidence and the practical interpretation behind the result.

Main objective: Compare SVM and XGBoost for car purchase propensity and evaluate accuracy, interpretability and practical use.

**PT-BR**

Comparacao de modelos, score de propensao e classificacao. Este projeto foi organizado como um estudo de caso pronto para portfolio: explica o objetivo, o caminho analitico, as evidencias visuais e a interpretacao pratica por tras do resultado.

Objetivo principal: Comparar SVM e XGBoost para propensao de compra de carros e avaliar acuracia, interpretabilidade e uso pratico.
